function run_track_all_cells_shift_2020_01_09(p,poslist,posctr,colors,range)   
...
[Lc_m,rreg_m,yreg_m,preg_m]=load_images_into_memory_preg_shift_2020_01_09_v1(p,poslist,posctr,range);
    ...
    if exist('Lc_m')
        ...
        if exist([p.imageDir,'channel_pos_',poslist{posctr}(10:11),'.txt'])
            ...
            for c=1:length(channels)
                ...
                track_core_shift_2020_01_09_v1m(p,Lc_m,yreg_m,rreg_m,preg_m,channels,c,colors,poslist,posctr)
            end
        end
    end