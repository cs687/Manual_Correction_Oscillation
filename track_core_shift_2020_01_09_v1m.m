function track_core_shift_2020_01_09_v1m(p,Lc_m,yreg_m,rreg_m,preg_m,channels,c,colors,poslist,posctr)
...
if ~exist([p.dateDir,strrep(poslist{posctr},'-','_'),'_', str2(c),'\data']);
